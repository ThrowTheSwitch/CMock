...
class CMockGenerator
  ...
  def create_mock(module_name, defnfile, parsed_stuff, target_folder)
    @module_name = module_name
    @mock_name   = @prefix + @module_name
    create_mock_header_file(parsed_stuff, defnfile, target_folder)
    create_mock_source_file(parsed_stuff, target_folder)
  end
  
  private if $ThisIsOnlyATest.nil? ##############################
  
  def create_mock_header_file(parsed_stuff, defnfile, target_folder)
